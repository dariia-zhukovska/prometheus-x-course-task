...
export default function Book({ bookItemData }: IProps) {
  ...
  return (
    <li className={styles.bookItem} >
      <div><img src={bookItemData.image || imageNotFound} alt="book_image" className={styles.bookItemImage} /></div>
      ...
      <div className={styles.bookItemPriceLine}>
        ...
        <button className={styles.bookItemButton} onClick={() => navigate(`/books/${bookItemData.id}`)}>
          View
        </button>
      </div>     
